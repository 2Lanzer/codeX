...
function checkDuplicate() {
    const itemText = itemInput.value.trim(); // Get and trim the input value
    
    if (listArr.includes(itemText)) {
        // If the item already exists in the array, show an alert
    ...
    renderList(); // Update the rendered list
}
